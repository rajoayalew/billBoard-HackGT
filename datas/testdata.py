...
with open('testcase.csv', 'w', newline='') as file:
    ...
    for i in range(1, times+1):
        ...
        dateadd = '{}-{}-{} {}:{}:{}'.format(dateaddyear, dateaddmatrix[0], dateaddmatrix[1], dateaddmatrix[2], dateaddmatrix[3], dateaddmatrix[4])
        datepro = '{}-{}-{} {}:{}:{}'.format(dateproyear, datepromatrix[0], datepromatrix[1], datepromatrix[2], datepromatrix[3], datepromatrix[4])
